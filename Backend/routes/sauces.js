...
// Création des différentes ROUTES de l'API en leurs précisant leurs middlewares et controllers

// Route qui permet de récupérer toutes les sauces
// Renvoie le tableau de toutes les sauces dans la base de données
router.get("/", auth, saucesRoutes.getAllSauce);

// Route qui permet de cliquer sur une des sauces précise
// Renvoie la sauce avec l'ID fourni
router.get("/:id", auth, saucesRoutes.getOneSauce);
...
router.post("/", auth, multer, saucesRoutes.createSauce);
...
router.put("/:id", auth, multer, saucesRoutes.modifySauce);

// Route qui permet de supprimer "une sauce"
// Supprime la sauce avec l'ID fourni.
router.delete("/:id", auth, saucesRoutes.deleteSauce);
...
router.post("/:id/like", auth, saucesRoutes.likeDislike);
