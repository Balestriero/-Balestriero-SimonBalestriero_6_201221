...
// On récupère notre model User, créé avec le schéma mongoose
...
exports.signup = (req, res, next) => {
  // On appelle la méthode hash de bcrypt et on lui passe le mdp de l'utilisateur, le salt (10) ce sera le nombre de tours qu'on fait faire à l'algorithme
  bcrypt
